...
import { StyleSheet, View, Text, ScrollView, ImageBackground, TouchableOpacity, Modal, Image } from 'react-native';
      ...
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <View style={styles.infoContainer}>
          ...
          <View style={styles.detailsContainer}>
            ...
            <Text style={[styles.detailText, styles.highlightText]}>Event Date</Text>
            <View style={styles.eventInfoOuterContainer}>
              <Text style={[styles.detailText, { color: 'black' }]}>12/00/23</Text>
            </View>
            <Text style={[styles.detailText, styles.highlightText]}>Event Type</Text>
            <View style={styles.eventInfoOuterContainer}>
              <Text style={[styles.detailText, { color: 'black' }]}>Wedding</Text>
            </View>
            <Text style={[styles.detailText, styles.highlightText]}>Location</Text>
            <View style={styles.eventInfoOuterContainer}>
              <Text style={[styles.detailText, { color: 'black' }]}>Benros Hotel, 976 Tiano Brothers St, Cagayan de Oro, 9000</Text>
            </View>
          </View>
        </View>
